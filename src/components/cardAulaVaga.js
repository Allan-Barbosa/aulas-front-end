...
export function Turma({ title, date, description, color1, color2, id, token, code, ...rest }) {
      ...
      <Center flex={1} px="3">
        <Pressable onPress={rest.onPress}>
          ...
          >
            ...
            <Button height={10} mt={2} onPress={() => {substituirAula(token, id, code)}} title="SUBSTITUIR AULA" />
          </Box>
        </Pressable>
      </Center>
    </NativeBaseProvider>
